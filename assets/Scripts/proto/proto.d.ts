...
export namespace pb {
    ...
    /** Represents a TransmissionNotify. */
    class TransmissionNotify implements ITransmissionNotify {

        /**
         * Constructs a new TransmissionNotify.
         * @param [properties] Properties to set
         */
        constructor(properties?: pb.ITransmissionNotify);
         ...
         * @param [properties] Properties to set
         * @returns TransmissionNotify instance
         */
        public static create(properties?: pb.ITransmissionNotify): pb.TransmissionNotify;

        /**
         * Encodes the specified TransmissionNotify message. Does not implicitly {@link pb.TransmissionNotify.verify|verify} messages.
         * @param message TransmissionNotify message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: pb.ITransmissionNotify, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: pb.ITransmissionNotify, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a TransmissionNotify message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns TransmissionNotify
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): pb.TransmissionNotify;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): pb.TransmissionNotify;
         ...
         * @returns TransmissionNotify
         */
        public static fromObject(object: { [k: string]: any }): pb.TransmissionNotify;

        /**
         * Creates a plain object from a TransmissionNotify message. Also converts values to other types if specified.
         * @param message TransmissionNotify
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: pb.TransmissionNotify, options?: $protobuf.IConversionOptions): { [k: string]: any };
