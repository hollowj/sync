...
$root.pb = (function() {
    ...
    pb.PingReq = (function() {
         ...
         * @memberof pb
         * @interface IPingReq
         * @property {number|null} [clientTickNo] PingReq clientTickNo
         */
         ...
         * @member {number} clientTickNo
         * @memberof pb.PingReq
         * @instance
         */
        PingReq.prototype.clientTickNo = 0;
        ...
        PingReq.encode = function encode(message, writer) {
            ...
            if (message.clientTickNo != null && Object.hasOwnProperty.call(message, "clientTickNo"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.clientTickNo);
            return writer;
        };
        ...
        PingReq.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1: {
                        message.clientTickNo = reader.uint32();
                        break;
                    }
                default:
        ...
        PingReq.verify = function verify(message) {
            ...
            if (message.clientTickNo != null && message.hasOwnProperty("clientTickNo"))
                if (!$util.isInteger(message.clientTickNo))
                    return "clientTickNo: integer expected";
            return null;
        };
        ...
        PingReq.fromObject = function fromObject(object) {
            ...
            if (object.clientTickNo != null)
                message.clientTickNo = object.clientTickNo >>> 0;
            return message;
        };
        ...
        PingReq.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.clientTickNo = 0;
            if (message.clientTickNo != null && message.hasOwnProperty("clientTickNo"))
                object.clientTickNo = message.clientTickNo;
            return object;
        };
    ...
    pb.PongRes = (function() {
         ...
         * @memberof pb
         * @interface IPongRes
         * @property {number|null} [serverTickNo] PongRes serverTickNo
         */
         ...
         * @member {number} serverTickNo
         * @memberof pb.PongRes
         * @instance
         */
        PongRes.prototype.serverTickNo = 0;
        ...
        PongRes.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.serverTickNo != null && Object.hasOwnProperty.call(message, "serverTickNo"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.serverTickNo);
            return writer;
        };
        ...
        PongRes.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1: {
                        message.serverTickNo = reader.uint32();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        PongRes.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.serverTickNo != null && message.hasOwnProperty("serverTickNo"))
                if (!$util.isInteger(message.serverTickNo))
                    return "serverTickNo: integer expected";
            return null;
        };
        ...
        PongRes.fromObject = function fromObject(object) {
            ...
            if (object.serverTickNo != null)
                message.serverTickNo = object.serverTickNo >>> 0;
            return message;
        };
        ...
        PongRes.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.serverTickNo = 0;
            if (message.serverTickNo != null && message.hasOwnProperty("serverTickNo"))
                object.serverTickNo = message.serverTickNo;
            return object;
        };
